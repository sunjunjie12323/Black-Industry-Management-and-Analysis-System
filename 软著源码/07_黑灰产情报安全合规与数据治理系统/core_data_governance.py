...
RETENTION_DAYS: Dict[ClassificationLevel, int] = {
    ClassificationLevel.PUBLIC: 90,
    ClassificationLevel.INTERNAL: 180,
    ClassificationLevel.CONFIDENTIAL: 365,
    ClassificationLevel.RESTRICTED: 365,
}
