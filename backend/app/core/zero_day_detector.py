...
class SkipGramModel:
    def __init__(self, vocab_size: int, embed_dim: int = 64, random_seed: int = 42):
...
class ZeroDayDetector:
    ...
    _COMMON_ENGLISH_WORDS = DEFAULT_STOP_WORDS
    ...
    def train(self, corpus: List[str], epochs: int = 3):
        ...
        self._model = SkipGramModel(len(self._word2idx), self.EMBED_DIM, random_seed=settings.RANDOM_SEED)
