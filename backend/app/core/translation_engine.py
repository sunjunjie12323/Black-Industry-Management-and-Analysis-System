...
class TerminologyInjector:
    ...
    def __init__(self):
        ...
        self._config_priority_map = settings.translation_priority_map
    ...
    def get_terminology_with_priority(
        ...
        if source_lang == "zh" and target_lang == "en":
            for term, translation in self.THREAT_INTEL_GLOSSARY_ZH_EN.items():
                priority = self._config_priority_map.get(term) or self.DEFAULT_PRIORITY_MAP.get(term, "suggest_translate")
